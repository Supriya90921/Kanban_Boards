...
export function KanbanColumn({
  ...
  return (
    <div
      className="flex flex-col bg-gray-50 rounded-lg min-w-[280px] flex-1 max-w-sm sm:min-w-[300px] sm:max-w-md"
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="bg-white bg-opacity-30 text-black text-xs font-medium px-2 py-0.5 rounded-full">
            {cards.length}
          </span>
        </div>
        <button
